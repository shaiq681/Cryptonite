...
st.markdown("""
Denna app hämtar kryptovalutapriser för de 100 bästa kryptovalutorna från **CoinMarketCap**
""")
...
* **Project:** Real-time scraping of Crypto-Currency values.
...
* **Credits:** 
    ...
    - Tutorial by Chanin Nantasenamat (aka Data Professor)[Build 12 Data Science Apps with Python and Streamlit](https://www.youtube.com/watch?v=JwSS70SZdyM&ab_channel=freeCodeCamp.org)
""")
...
if currency_price_unit=='BTC':
  currency_price_unit = 0
elif currency_price_unit=='ETH':
  currency_price_unit = 1
elif currency_price_unit=='USD':
  currency_price_unit = 2
# currency_price_unit = col1.selectbox('Select currency for price', (0,1,2))
...
def load_data():
  ...
  for i in listings:
    ...
    percent_change_1h.append(i['quotes'][currency_price_unit]['percentChange1h'])
    percent_change_24h.append(i['quotes'][currency_price_unit]['percentChange24h'])
    percent_change_7d.append(i['quotes'][currency_price_unit]['percentChange7d'])
    market_cap.append(i['quotes'][currency_price_unit]['marketCap'])
    volume_24h.append(i['quotes'][currency_price_unit]['volume24h'])
